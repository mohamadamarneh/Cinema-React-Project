      ...
      <div class="section section-padding pb-0 mt5 " >
        <div class="container">
          <div class="row learts-mb-n30">
            ...
            <div class="col-md-6 col-12 text-center learts-mb-30" >
              <div class="about-us3" style={{ color: "white", textAlign: "left", marginTop: "100px" }}>

                <h2 class="title">7FLEX</h2>
                <div class="desc">
